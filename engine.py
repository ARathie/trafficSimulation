...
class Event:
    ...
    def randomEventType(self):
        ...
        randNum = random.randint(1,10) #pseudo-randomly outputs 1-10
        #higher probability that cars come from east / west than north / south
        if randNum < 4:
    ...
    def pedWalkType(self):
        self.setEventType("PW")
